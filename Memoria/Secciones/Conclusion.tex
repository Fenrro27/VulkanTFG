...
Como hemos visto a los largo del desarrollo los efectos generados son lo suficientemente convincentes como para decir que ha sido un exito la ganeracion de efectos visuales convincentes.
...
\begin{itemize}
    ...
    \item \textbf{Sombras:} Desarrollar mapas de sombras específicos para los sistemas volumétricos (\textit{shadow maps} para partículas), permitiendo que el humo densificado proyecte sombras sobre sí mismo y sobre la geometría del escenario, elevando drásticamente el nivel de profundidad visual.
