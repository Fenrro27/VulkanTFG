/**
 * @file GEComputeShader.cpp
 * @brief Archivo GEComputeShader.cpp
 */
...
/**
 * @brief FunciÃ³n GEComputeShader::createDescriptorSetLayout
 */
...
/**
 * @brief FunciÃ³n GEComputeShader::createDescriptorSets
 */
...
int GEComputeShader::addParticleSystem(GEGraphicsContext* gc, uint32_t imageCount, GEParticlesSystem* particleSystem) {
    ...
    /**
     * @brief FunciÃ³n newDescriptorSets
     */
    ...
    // Actualizar Sets con la LÃGICA PING-PONG
    for (size_t i = 0; i < imageCount; i++) {
        // Alternamos cuÃ¡l es entrada (binding 0) y cuÃ¡l es salida (binding 1)
...
/**
 * @brief FunciÃ³n GEComputeShader::createComputePipeline
 */
...
/**
 * @brief FunciÃ³n GEComputeShader::recordCommands
 */
...
/**
 * @brief FunciÃ³n GEComputeShader::destroy
 */
...
/**
 * @brief FunciÃ³n GEComputeShader::getFileFromResource
 */
...
/**
 * @brief FunciÃ³n GEComputeShader::createShaderModule
 */
