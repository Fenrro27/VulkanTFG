...
/**
 * @brief Función GEComputeShader::createDescriptorSetLayout
 */
...
/**
 * @brief Función GEComputeShader::createDescriptorSets
 */
...
int GEComputeShader::addParticleSystem(GEGraphicsContext* gc, uint32_t imageCount, GEParticlesSystem* particleSystem) {
    ...
    /**
     * @brief Función newDescriptorSets
     */
...
/**
 * @brief Función GEComputeShader::createComputePipeline
 */
...
/**
 * @brief Función GEComputeShader::recordCommands
 */
...
/**
 * @brief Función GEComputeShader::destroy
 */
...
/**
 * @brief Función GEComputeShader::createShaderModule
 */
