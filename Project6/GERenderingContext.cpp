 ...
 * @brief Archivo GERenderingContext.cpp
 */
...
//
// FUNCIï¿½N: GERenderingContext::GERenderingContext()
//
// PROPï¿½SITO: Crea un contexto de renderizado (pipelines, renderpass y framebuffer) 
//
...
//
// FUNCIï¿½N: GERenderingContext::destroy(GEGraphicsContext* gc)
//
// PROPï¿½SITO: Crea el estado de Vulkan
//
/**
 * @brief FunciÃ³n GERenderingContext::destroy
 */
...
//
// FUNCIï¿½N: GERenderingContext::createGraphicsPipeline()
//
// PROPï¿½SITO: Aï¿½ade un nuevo Pipeline de renderizado
//
/**
 * @brief FunciÃ³n GERenderingContext::addGraphicsPipeline
 */
...
//
// FUNCIï¿½N: GERenderingContext::setActivePipeline(uint32_t index)
//
// PROPï¿½SITO: Asigna el pipeline activo
//
/**
 * @brief FunciÃ³n GERenderingContext::setActivePipeline
 */
...
//
// FUNCIï¿½N: GERenderingContext::getActiveDescriptorSetLayout()
//
// PROPï¿½SITO: Obtiene la plantilla de descriptor set del pipeline activo
//
/**
 * @brief FunciÃ³n GERenderingContext::getActiveDescriptorSetLayout
 */
...
//
// FUNCIï¿½N: GERenderingContext::getActivePipelineLayout()
//
// PROPï¿½SITO: Obtiene la plantilla de pipeline del pipeline activo
//
/**
 * @brief FunciÃ³n GERenderingContext::getActivePipelineLayout
 */
...
//
// FUNCIï¿½N: GERenderingContext::insertBeginCommands(std::vector<VkCommandBuffer> commandBuffers)
//
// PROPï¿½SITO: Aï¿½ade la inicializaciï¿½n del renderpass a los buffers de comandos
//
/**
 * @brief FunciÃ³n GERenderingContext::insertBeginCommands
 */
...
//
// FUNCIï¿½N: GERenderingContext::insertPipelineCommands(std::vector<VkCommandBuffer> commandBuffers)
//
// PROPï¿½SITO: Aï¿½ade la selecciï¿½n de pipeline a los buffers de comandos
//
/**
 * @brief FunciÃ³n GERenderingContext::insertPipelineCommands
 */
...
//
// FUNCIï¿½N: GERenderingContext::insertEndCommands(std::vector<VkCommandBuffer> commandBuffers)
//
// PROPï¿½SITO: Aï¿½ade la finalizaciï¿½n del renderpass a los buffers de comandos
//
/**
 * @brief FunciÃ³n GERenderingContext::insertEndCommands
 */
...
//
// FUNCIï¿½N: GERenderingContext::createRenderPass()
//
// PROPï¿½SITO: Crea los pasos de renderizado
//
/**
 * @brief FunciÃ³n GERenderingContext::createRenderPass
 */
void GERenderingContext::createRenderPass(GEGraphicsContext* gc)
{
	...
	{
		/**
		 * @brief FunciÃ³n std::runtime_error
		 */
...
// FUNCIï¿½N: GERenderingContext::createGraphicsPipeline()
//
// PROPï¿½SITO: Crea el Pipeline de renderizado
//
/**
 * @brief FunciÃ³n GERenderingContext::createGraphicsPipeline
 */
...
//
// FUNCIï¿½N: GERenderingContext::createDepthBuffers()
//
// PROPï¿½SITO: Crea los buffers de profundidad
//
/**
 * @brief FunciÃ³n GERenderingContext::createDepthBuffers
 */
...
//
// FUNCIï¿½N: GERenderingContext::createFramebuffers()
//
// PROPï¿½SITO: Crea un Framebuffer para cada imagen del swapchain
//
...
///////////////////////////////////////////////////////////////////////////////////////////
/////                                                                                 /////
/////              Mï¿½todos de definiciï¿½n del pipeline de renderizado                  /////
/////                                                                                 /////
///////////////////////////////////////////////////////////////////////////////////////////

//
// FUNCIï¿½N: CAVulkanState::createPipelineLayout()
//
// PROPï¿½SITO: Crea el esquema de los conjuntos de descriptores
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineLayout
 */
...
//
// FUNCIï¿½N: GERenderingContext::createVertexShaderStageCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n sobre el Vertex Shader
//
/**
 * @brief FunciÃ³n GERenderingContext::createVertexShaderStageCreateInfo
 */
...
//
// FUNCIï¿½N: GERenderingContext::createFragmentShaderStageCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n sobre el Vertex Shader
//
/**
 * @brief FunciÃ³n GERenderingContext::createFragmentShaderStageCreateInfo
 */
...
//
// FUNCIï¿½N: GERenderingContext::createPipelineVertexInputStateCreateInfo()
//
// PROPï¿½SITO: Crea la descripciï¿½n de los atributos de los vï¿½rtices
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineVertexInputStateCreateInfo
 */
...
// FUNCIï¿½N: GERenderingContext::createPipelineVertexInputStateCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n para el ensamblado de primitivas
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineInputAssemblyStateCreateInfo
 */
...
//
// FUNCIï¿½N: CAVulkanState::createPipelineViewportStateCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n del viewport
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineViewportStateCreateInfo
 */
...
//
// FUNCIï¿½N: GERenderingContext::createPipelineRasterizationStateCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n de la etapa de rasterizaciï¿½n
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineRasterizationStateCreateInfo
 */
...
// FUNCIï¿½N: GERenderingContext::createPipelineRasterizationStateCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n de la etapa de sampleado
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineMultisampleStateCreateInfo
 */
...
// FUNCIï¿½N: GERenderingContext::createPipelineRasterizationStateCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n sobre los tests de profundidad y de plantilla
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineDepthStencilStateCreateInfo
 */
...
//
// FUNCIï¿½N: GERenderingContext::createPipelineColorBlendStateCreateInfo()
//
// PROPï¿½SITO: Crea la informaciï¿½n sobre la etapa de mezcla de colores
//
/**
 * @brief FunciÃ³n GERenderingContext::createPipelineColorBlendStateCreateInfo
 */
...
//
// FUNCIï¿½N: GERenderingContext::createShaderModule()
//
// PROPï¿½SITO: Crea un shader a partir de su cï¿½digo en SPIR-V
//
/**
 * @brief FunciÃ³n GERenderingContext::createShaderModule
 */
...
//
// FUNCIï¿½N: GERenderingContext::getFileFromResource(int resource)
//
// PROPï¿½SITO: Extrae el contenido de un fichero incluido como recurso de la aplicaciï¿½n
//
/**
 * @brief FunciÃ³n GERenderingContext::getFileFromResource
 */
